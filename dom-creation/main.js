...
function renderPokemon(pokemon) {
  ...
  var image = document.createElement('img'); // can I createElement in cardDiv instead?
  ...
  var pokedex = document.createElement('h3');
  var pokedexNum = document.createTextNode(pokemon.number);
  pokedex.appendChild(pokedexNum);
  cardText.appendChild(pokedex);
...
// loop through Pokedex array
for (let i = 0; i < pokedex.length; i++) {
  var results = renderPokemon(pokedex[i]);
  $rows.appendChild(results);
}
